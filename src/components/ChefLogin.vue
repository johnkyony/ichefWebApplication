...
import {mapState} from 'vuex'
    ...
    computed: {
     ...
     methods: {
       ...
       login(){
      this.$store.dispatch('login' , {email: this.loginForm.email , password: this.loginForm.password , role: "chef"})
      .then(() => {
      ...
      signup(){
       this.$store.dispatch('signup', {email: this.signupForm.email , password: this.signupForm.password , name: this.signupForm.name , role: "chef"})
       .then(() => {
